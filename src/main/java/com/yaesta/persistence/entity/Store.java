...
@Entity
@Table(name = "store",schema="yaesta")
public class Store implements Serializable{
	 ...
	 * Serial version
	 */
	private static final long serialVersionUID = 2093702058662328216L;

	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "store_seq_gen")
	@SequenceGenerator(name = "store_seq_gen", sequenceName = "store_id_seq")
	private Long id;

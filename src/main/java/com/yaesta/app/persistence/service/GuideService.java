...
public class GuideService {
	...
	public List<GuideVO> findByStatusAndDeliveryDate(GuideSearchVO guideSearch){
		...
		List<Guide> found = guideRepository.findByStatusAndStrDeliveryDate(guideSearch.getStatus(), UtilDate.fromDateToString(guideSearch.getDeliveryDate(), "yyyy-MM-dd"));
	...
	public List<GuideVO> findByStatusAndDeliveryDateAndDeliveryName(String status, Date deliveryDate, String deliveryName){
	...
	public List<GuideVO> findByStatusAndDeliveryDateAndDeliveryName(GuideSearchVO guideSearch){
		...
		List<Guide> found = guideRepository.findByStatusAndStrDeliveryDateAndDeliveryName(guideSearch.getStatus(), UtilDate.fromDateToString(guideSearch.getDeliveryDate(), "yyyy-MM-dd"),guideSearch.getDeliveryName());
	...
	public List<GuideVO> findByOrderDateBetweenAndStatus(GuideSearchVO guideSearch){
		...
		List<Guide> found = guideRepository.findByOrderDateBetweenAndStatus(guideSearch.getStartDate(),guideSearch.getStartDate(),guideSearch.getStatus());
	...
	public GuideDeliveryNotificationVO sendProgrammedGuides(GuideSearchVO guideSearch){
		...
		mailTramaco = completeMailForCourier(mailTramaco,"TRAMACO",UtilDate.fromDateToString(guideSearch.getDeliveryDate(), "yyyy-MM-dd"));
		...
		mailMotoExpress = completeMailForCourier(mailMotoExpress,"MOTO_EXPRESS",UtilDate.fromDateToString(guideSearch.getDeliveryDate(), "yyyy-MM-dd"));
		...
		mailCiclista = completeMailForCourier(mailCiclista,"CICLISTA",UtilDate.fromDateToString(guideSearch.getDeliveryDate(), "yyyy-MM-dd"));
		...
		mailDespachoInterno = completeMailForCourier(mailDespachoInterno,"DESPACHO_INTERNO",UtilDate.fromDateToString(guideSearch.getDeliveryDate(), "yyyy-MM-dd"));
		...
		mailTCC = completeMailForCourier(mailTCC,"TCC",UtilDate.fromDateToString(guideSearch.getDeliveryDate(), "yyyy-MM-dd"));
		...
		mailLAAR = completeMailForCourier(mailLAAR,"LAAR",UtilDate.fromDateToString(guideSearch.getDeliveryDate(), "yyyy-MM-dd"));
	...
	private MailInfo preparedMailInfo(GuideSearchVO guideSearch){
		...
		List<Guide> foundGuide = guideRepository.findByStatusAndStrDeliveryDateAndDeliveryName(guideSearch.getStatus(), UtilDate.fromDateToString(guideSearch.getDeliveryDate(), "yyyy-MM-dd"),guideSearch.getDeliveryName());

...
@XmlRootElement(name = "GiftCardGetByRedeptionCode")
public class GiftCardGetByRedeptionCode {

    @XmlElementRef(name = "redeptionCode", namespace = "http://tempuri.org/", type = JAXBElement.class)

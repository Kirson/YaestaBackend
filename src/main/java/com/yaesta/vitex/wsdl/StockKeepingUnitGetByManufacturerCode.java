...
@XmlRootElement(name = "StockKeepingUnitGetByManufacturerCode")
public class StockKeepingUnitGetByManufacturerCode {

    @XmlElementRef(name = "manufacturer", namespace = "http://tempuri.org/", type = JAXBElement.class)

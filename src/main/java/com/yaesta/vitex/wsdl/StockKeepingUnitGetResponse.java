...
public class StockKeepingUnitGetResponse {
    ...
    @XmlElementRef(name = "StockKeepingUnitGetResult", namespace = "http://tempuri.org/", type = JAXBElement.class)
    protected JAXBElement<StockKeepingUnitDTO> stockKeepingUnitGetResult;

    /**
     * Gets the value of the stockKeepingUnitGetResult property.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Sets the value of the stockKeepingUnitGetResult property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link StockKeepingUnitDTO }{@code >}
    ...
    public void setStockKeepingUnitGetResult(JAXBElement<StockKeepingUnitDTO> value) {
        this.stockKeepingUnitGetResult = ((JAXBElement<StockKeepingUnitDTO> ) value);
    }

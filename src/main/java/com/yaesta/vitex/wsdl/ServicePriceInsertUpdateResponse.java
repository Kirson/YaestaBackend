...
public class ServicePriceInsertUpdateResponse {
    ...
    @XmlElementRef(name = "ServicePriceInsertUpdateResult", namespace = "http://tempuri.org/", type = JAXBElement.class)
    protected JAXBElement<ServicePriceDTO> servicePriceInsertUpdateResult;
    @XmlElementRef(name = "servicePriceId", namespace = "http://tempuri.org/", type = JAXBElement.class)
    protected JAXBElement<Integer> servicePriceId;

    /**
     * Gets the value of the servicePriceInsertUpdateResult property.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Sets the value of the servicePriceInsertUpdateResult property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link ServicePriceDTO }{@code >}
    ...
    public void setServicePriceInsertUpdateResult(JAXBElement<ServicePriceDTO> value) {
        this.servicePriceInsertUpdateResult = ((JAXBElement<ServicePriceDTO> ) value);
    }

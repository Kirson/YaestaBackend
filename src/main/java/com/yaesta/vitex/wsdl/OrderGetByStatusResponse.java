...
public class OrderGetByStatusResponse {
    ...
    @XmlElementRef(name = "OrderGetByStatusResult", namespace = "http://tempuri.org/", type = JAXBElement.class)
    protected JAXBElement<ArrayOfOrderDTO> orderGetByStatusResult;

    /**
     * Gets the value of the orderGetByStatusResult property.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Sets the value of the orderGetByStatusResult property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link ArrayOfOrderDTO }{@code >}
    ...
    public void setOrderGetByStatusResult(JAXBElement<ArrayOfOrderDTO> value) {
        this.orderGetByStatusResult = ((JAXBElement<ArrayOfOrderDTO> ) value);
    }

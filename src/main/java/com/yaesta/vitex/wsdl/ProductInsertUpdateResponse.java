...
public class ProductInsertUpdateResponse {
    ...
    @XmlElementRef(name = "ProductInsertUpdateResult", namespace = "http://tempuri.org/", type = JAXBElement.class)
    protected JAXBElement<ProductDTO> productInsertUpdateResult;

    /**
     * Gets the value of the productInsertUpdateResult property.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Sets the value of the productInsertUpdateResult property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link ProductDTO }{@code >}
    ...
    public void setProductInsertUpdateResult(JAXBElement<ProductDTO> value) {
        this.productInsertUpdateResult = ((JAXBElement<ProductDTO> ) value);
    }

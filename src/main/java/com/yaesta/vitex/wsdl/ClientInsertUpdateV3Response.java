...
public class ClientInsertUpdateV3Response {
    ...
    @XmlElementRef(name = "ClientInsertUpdateV3Result", namespace = "http://tempuri.org/", type = JAXBElement.class)
    protected JAXBElement<ClientDTO> clientInsertUpdateV3Result;

    /**
     * Gets the value of the clientInsertUpdateV3Result property.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Sets the value of the clientInsertUpdateV3Result property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link ClientDTO }{@code >}
    ...
    public void setClientInsertUpdateV3Result(JAXBElement<ClientDTO> value) {
        this.clientInsertUpdateV3Result = ((JAXBElement<ClientDTO> ) value);
    }

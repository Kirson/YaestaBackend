...
public class StoreGetResponse {
    ...
    @XmlElementRef(name = "StoreGetResult", namespace = "http://tempuri.org/", type = JAXBElement.class)
    protected JAXBElement<StoreDTO> storeGetResult;

    /**
     * Gets the value of the storeGetResult property.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Sets the value of the storeGetResult property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link StoreDTO }{@code >}
    ...
    public void setStoreGetResult(JAXBElement<StoreDTO> value) {
        this.storeGetResult = ((JAXBElement<StoreDTO> ) value);
    }

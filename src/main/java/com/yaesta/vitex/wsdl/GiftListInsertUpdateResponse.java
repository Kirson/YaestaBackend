...
public class GiftListInsertUpdateResponse {
    ...
    @XmlElementRef(name = "GiftListInsertUpdateResult", namespace = "http://tempuri.org/", type = JAXBElement.class)
    protected JAXBElement<GiftListDTO> giftListInsertUpdateResult;

    /**
     * Gets the value of the giftListInsertUpdateResult property.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Sets the value of the giftListInsertUpdateResult property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link GiftListDTO }{@code >}
    ...
    public void setGiftListInsertUpdateResult(JAXBElement<GiftListDTO> value) {
        this.giftListInsertUpdateResult = ((JAXBElement<GiftListDTO> ) value);
    }

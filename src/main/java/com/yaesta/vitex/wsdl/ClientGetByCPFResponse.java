...
public class ClientGetByCPFResponse {
    ...
    @XmlElementRef(name = "ClientGetByCPFResult", namespace = "http://tempuri.org/", type = JAXBElement.class)
    protected JAXBElement<ClientDTO> clientGetByCPFResult;

    /**
     * Gets the value of the clientGetByCPFResult property.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Sets the value of the clientGetByCPFResult property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link ClientDTO }{@code >}
    ...
    public void setClientGetByCPFResult(JAXBElement<ClientDTO> value) {
        this.clientGetByCPFResult = ((JAXBElement<ClientDTO> ) value);
    }

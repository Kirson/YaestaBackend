...
public class ProductInsertUpdate {
    ...
    @XmlElementRef(name = "productVO", namespace = "http://tempuri.org/", type = JAXBElement.class)
    protected JAXBElement<ProductDTO> productVO;

    /**
     * Gets the value of the productVO property.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Sets the value of the productVO property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link ProductDTO }{@code >}
    ...
    public void setProductVO(JAXBElement<ProductDTO> value) {
        this.productVO = ((JAXBElement<ProductDTO> ) value);
    }

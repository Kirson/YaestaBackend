...
public class ClientGetByGuidV3Response {
    ...
    @XmlElementRef(name = "ClientGetByGuidV3Result", namespace = "http://tempuri.org/", type = JAXBElement.class)
    protected JAXBElement<ClientDTO> clientGetByGuidV3Result;

    /**
     * Gets the value of the clientGetByGuidV3Result property.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Sets the value of the clientGetByGuidV3Result property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link ClientDTO }{@code >}
    ...
    public void setClientGetByGuidV3Result(JAXBElement<ClientDTO> value) {
        this.clientGetByGuidV3Result = ((JAXBElement<ClientDTO> ) value);
    }

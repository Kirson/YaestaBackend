...
public class IntegrationLogErrorInsertUpdate {
    ...
    @XmlElementRef(name = "instance", namespace = "http://tempuri.org/", type = JAXBElement.class)
    ...
    @XmlElementRef(name = "errorDetail", namespace = "http://tempuri.org/", type = JAXBElement.class)

...
@XmlRootElement(name = "StockKeepingUnitGetByRefId")
public class StockKeepingUnitGetByRefId {

    @XmlElementRef(name = "refId", namespace = "http://tempuri.org/", type = JAXBElement.class)
